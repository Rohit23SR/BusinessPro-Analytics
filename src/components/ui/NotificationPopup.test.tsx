...
describe('NotificationPopup', () => {
  ...
  it('should render when show is true', () => {
    render(<NotificationPopup show={true} message="Success!" onClose={vi.fn()} />)
  ...
  it('should display the message', () => {
    render(
      <NotificationPopup show={true} message="Settings saved successfully" onClose={vi.fn()} />
    )
  ...
  it('should call onClose when close button is clicked', () => {
    ...
    render(<NotificationPopup show={true} message="Test" onClose={mockOnClose} />)
  ...
  it('should have fixed positioning', () => {
    const { container } = render(<NotificationPopup show={true} message="Test" onClose={vi.fn()} />)
  ...
  it('should render check icon', () => {
    render(<NotificationPopup show={true} message="Test" onClose={vi.fn()} />)
  ...
  it('should handle long messages with truncation', () => {
    ...
    render(<NotificationPopup show={true} message={longMessage} onClose={vi.fn()} />)
