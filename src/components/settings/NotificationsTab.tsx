    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h4 className="text-md font-semibold text-gray-900 dark:text-gray-100">Email Notifications</h4>
            <p className="text-xs text-gray-500 dark:text-gray-400">Receive updates in your inbox</p>
          </div>
        </div>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Critical Alerts</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Get notified about urgent issues immediately</p>
            </div>
            <input
              type="checkbox"
              checked={settings.emailAlerts}
              onChange={(e) => onSettingChange('emailAlerts', e.target.checked)}
              className="w-5 h-5 rounded border-gray-300 dark:border-gray-500 text-indigo-600 focus:ring-indigo-500 cursor-pointer dark:bg-gray-700"
            />
          </div>
          <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Weekly Reports</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Summary of your weekly performance metrics</p>
            </div>
            <input
              type="checkbox"
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h4 className="text-md font-semibold text-gray-900 dark:text-gray-100">Push Notifications</h4>
            <p className="text-xs text-gray-500 dark:text-gray-400">Real-time alerts on your device</p>
          </div>
        </div>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Real-time Alerts</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Instant notifications for important events</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">New features and platform updates</p>
            </div>
            <input
              type="checkbox"
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h4 className="text-md font-semibold text-gray-900 dark:text-gray-100">Alert Thresholds</h4>
            <p className="text-xs text-gray-500 dark:text-gray-400">Set when you want to be notified about metric changes</p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white dark:bg-gray-600 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
            ...
            <div className="flex items-center">
              <input
                ...
                min="1"
                max="100"
                className="w-20 p-2 border border-gray-300 dark:border-gray-500 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-center bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              />
              <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">%</span>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Alert when conversion drops by this percentage</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-600 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Alert when traffic drops by this percentage</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="text-md font-semibold text-gray-900 dark:text-gray-100">Notification History</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">View your recent notifications</p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600 p-4">
