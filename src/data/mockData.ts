...
export const mockData: MockData = {
  ...
  analytics: {
    ...
    userBehavior: {
      '7d': {
        heatmapData: [
          { hour: 0, day: 0, value: 12 },
          { hour: 6, day: 0, value: 28 },
          { hour: 12, day: 0, value: 65 },
          { hour: 18, day: 0, value: 42 },
          { hour: 0, day: 1, value: 15 },
          { hour: 9, day: 1, value: 82 },
        ],
        deviceBreakdown: [
      ...
      '30d': {
        heatmapData: [
          { hour: 0, day: 0, value: 10 },
          { hour: 1, day: 0, value: 8 },
          { hour: 8, day: 0, value: 45 },
          { hour: 12, day: 0, value: 60 },
          { hour: 18, day: 0, value: 38 },
          { hour: 22, day: 0, value: 25 },
          { hour: 0, day: 1, value: 12 },
          { hour: 9, day: 1, value: 78 },
          { hour: 14, day: 1, value: 85 },
          { hour: 19, day: 1, value: 42 },
        ],
        deviceBreakdown: [
      ...
      '90d': {
        heatmapData: [
          { hour: 0, day: 0, value: 15 },
          { hour: 6, day: 0, value: 35 },
          { hour: 12, day: 0, value: 75 },
          { hour: 18, day: 0, value: 52 },
          { hour: 0, day: 1, value: 18 },
          { hour: 9, day: 1, value: 88 },
        ],
        deviceBreakdown: [
      ...
      '6m': {
        heatmapData: [
          { hour: 0, day: 0, value: 18 },
          { hour: 6, day: 0, value: 42 },
          { hour: 12, day: 0, value: 85 },
          { hour: 18, day: 0, value: 58 },
          { hour: 0, day: 1, value: 22 },
          { hour: 9, day: 1, value: 95 },
        ],
        deviceBreakdown: [
      ...
      '12m': {
        heatmapData: [
          { hour: 0, day: 0, value: 22 },
          { hour: 6, day: 0, value: 48 },
          { hour: 12, day: 0, value: 95 },
          { hour: 18, day: 0, value: 65 },
          { hour: 0, day: 1, value: 25 },
          { hour: 9, day: 1, value: 105 },
        ],
        deviceBreakdown: [
