...
export const dashboardApi = {
  ...
  getKPIs: async (timeframe: TimeFrame = '30d'): Promise<ApiResponse<KPI[]>> => {
    ...
    return createApiResponse(mockData.dashboard.kpis[timeframe] || mockData.dashboard.kpis['30d'])
  },
  ...
  getTopProducts: async (
    ...
    const products =
      mockData.dashboard.topProducts[timeframe]?.slice(0, limit) ||
...
export const analyticsApi = {
  ...
  getConversionFunnel: async (
    ...
    const funnel =
      mockData.analytics.conversionFunnel[timeframe] || mockData.analytics.conversionFunnel['30d']
    return createApiResponse({
      funnel,
      appliedFilters: filters,
    })
  ...
  getUserBehavior: async (
    ...
    const behavior =
      mockData.analytics.userBehavior[timeframe] || mockData.analytics.userBehavior['30d']
    return createApiResponse({
      ...behavior,
      appliedFilters: filters,
    })
  ...
  getTopLandingPages: async (
    ...
    const pages =
      mockData.analytics.topLandingPages[timeframe]?.slice(0, limit) ||
  ...
  getCohortAnalysis: async (
    ...
    const cohort =
      mockData.analytics.cohortAnalysis[type] || mockData.analytics.cohortAnalysis.weekly
