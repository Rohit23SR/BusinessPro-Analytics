...
export const queryKeys = {
  ...
  dashboard: {
    ...
    products: (timeframe: string, limit: number) =>
      ['dashboard', 'products', timeframe, limit] as const,
  },

  // Analytics keys
  analytics: {
    all: ['analytics'] as const,
    overview: (timeframe: string, filters: object) =>
      ['analytics', 'overview', timeframe, filters] as const,
    traffic: (timeframe: string, filters: object) =>
      ['analytics', 'traffic', timeframe, filters] as const,
    funnel: (timeframe: string, filters: object) =>
      ['analytics', 'funnel', timeframe, filters] as const,
    behavior: (timeframe: string, filters: object) =>
      ['analytics', 'behavior', timeframe, filters] as const,
